...
A voice VLAN is configured for the VoIP phone.<br/>
VTP is enabled on the switches, all of them running version 2, and 3 of three switches running in client mode, and one switch running in server mode.<br/>
